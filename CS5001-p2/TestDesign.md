...
21. Stops adding items when reaching the maximum stock limit. 
22. Throws IllegalStateException when trying to add items beyond the stock limit. 
23. Works correctly with a custom stock limit (e.g. limit of 5 items).
